...
// "system". Default is "dark" for every visitor regardless of OS preference — users
// can still opt into light or system via the toggle in the navbar, but first-time
// visitors always land in dark mode.
